...
1. Data cleaning
   - Change the package path and file path

2. Regional Analysis Plot -- Regional pleiotropy analysis for CRC vs IBD and Table of Summary of regional pleiotropy analysis across 22 autosomal chromosomes.
...
5. Table1 -- Method Comparision Table
   - First, correct the path in `two-way pleiotropy analysis.R` and run.
